...
const ARCHIVOS = ['/', '/equipos', '/manifest.webmanifest', '/icono.svg', '/revision.js', '/lectura.js', '/texto-voz.js', '/reglas.js', '/esquema.js', '/verificar', '/verificar.js', '/sucursal', '/tablero'];
