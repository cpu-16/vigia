...
Responde un dato si lo solicita. Puedes pulsar **Escuchar pregunta** y **Detener** para mostrar brevemente la voz opcional de QVAC en la laptop. Si necesitas corregir la transcripción, usa **Editar relato**: se abre dentro de la visita. Aplica el cambio y revisa los datos. Durante las preguntas pulsa **Tomar foto** en la barra inferior, fotografía la placa y confirma la unidad correspondiente. Muestra que siguen siendo dos unidades: una con serie y la otra con el modelo pendiente. Pulsa **Guardar con datos pendientes**, confirma si los viste directamente y guarda.
